...
function App() {
  useEffect(() => {
    ...
    indexLinks.forEach((link) => link.addEventListener('click', handleIndexClick))
    ...
    return () => {
      ...
      indexLinks.forEach((link) => link.removeEventListener('click', handleIndexClick))
    }
  }, [])
            ...
            <div className="container" data-reveal>
              ...
              <div className="split-cards">
                <div className="mini-card">
                  ...
                  <a href="https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11522374" target="_blank" rel="noreferrer">논문 보기</a>
                </div>
                <div className="mini-card">
                  <h3>수상</h3>
